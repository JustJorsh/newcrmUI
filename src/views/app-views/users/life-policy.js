...
const LifePolicyReport = ({year}) => {
    ...
    const getReport = async () => {
        ...
        try {
            ...
            const response = await client.get('customers/life_policies_count_per_month');
    ...
    return loading ? (
        ...
        <ChartWidget
            card
            series={[
                { name: 'HLA', data: reports?.map((r) => r.HLA) },
            ]}
...
export default LifePolicyReport;
